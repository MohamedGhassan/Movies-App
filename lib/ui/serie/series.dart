...
class _SeriesState extends ResumableState<Series> {
  ...
  void _getList() async {
    ...
    page = 0;
    _showLoading();
    var response = await apiRest.getSeriesByFiltres(
                          ...
                          child: Row(
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Container(
                                  padding: EdgeInsets.symmetric(
                                      horizontal: Responsive.isMobile(context) ? 1 : 10),
                        ...
                        child: Container(
                          ...
                          child: ScrollConfiguration(
                            ...
                            child: ScrollablePositionedList.builder(
                              itemCount: (series.length / _series_element_by_line).ceil(),
                              scrollDirection: Axis.vertical,
                              itemScrollController: _scrollController,
                              itemBuilder: (context, jndex) {
                                int items_line_count =
                                    (series.length - ((jndex + 1) * _series_element_by_line) > 0)
                                        ? _series_element_by_line
                                        : (series.length - (jndex * _series_element_by_line)).abs();
      ...
      Navigator.push(
        ...
        PageRouteBuilder(
          pageBuilder: (context, animation1, animation2) =>
              Serie(serie: series[_focused_poster]),
          transitionDuration: Duration(seconds: 0),
        ),
      );
      FocusScope.of(context).requestFocus(null);
  ...
  Widget _seriesLineGridWidget(jndex, int itemCount) {
    return Container(
      height: 150,
      child: Column(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                      ...
                      setState(() {
                        ...
                        Future.delayed(Duration(milliseconds: 250), () {
                          Navigator.push(
                            ...
                            PageRouteBuilder(
                              pageBuilder: (context, animation1, animation2) =>
                                  Serie(serie: series[(jndex * _series_element_by_line) + index]),
                              transitionDuration: Duration(seconds: 0),
                            ),
                          );
                        });
                    ...
                    child: MovieWidget(
                        ...
                        movie: series[(jndex * _series_element_by_line) + index]));
              },
            ),
          )
        ],
